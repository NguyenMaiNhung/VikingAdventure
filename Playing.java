...
import ui.BeforeGameOverOverlay;
...
public class Playing extends State implements Statemethods {
	...
	private LevelCompletedOverlay levelCompletedOverlay;
        private BeforeGameOverOverlay beforeGameOverOverlay;
	private Rain rain;
	...
	private boolean gameOver;
        private boolean beforeGameOver;
	...
	private void initClasses() throws IOException {
		...
		pauseOverlay = new PauseOverlay(this);
                beforeGameOverOverlay = new BeforeGameOverOverlay(this);
	...
	public void update() {
		if (paused)
			...
			gameCompletedOverlay.update();
                else if (beforeGameOver)
                        beforeGameOverOverlay.update();
		else if (gameOver)
	...
	public void draw(Graphics g) {
		...
		if (paused) {
			...
			pauseOverlay.draw(g);
                    ...
                    beforeGameOverOverlay.draw(g);
                    if(beforeGameOverOverlay.getYesButton().isMousePressed() && this.getGame().getShop().getCount()[2] <= 0){
                        beforeGameOverOverlay.drawNotice(g);
                    }
                }
	...
	public void resetAll() {
                if(gameOver == true){
                    player.resetAllForGameOver();
                    objectManager.resetAllObjectsForGameOver();
                    enemyManager.resetAllEnemies();
                }
                else if(lvlCompleted){
                    player.resetAllForLvlCompleted();
                    objectManager.resetAllObjectsForLvlCompleted();
                    enemyManager.resetAllEnemies();
                }
                else if(gameCompleted){
                    player.resetAllForGameOver();
                    ...
                    player.resetAllForGameOver();
                    objectManager.resetAllObjectsForReLife();
                }
		gameOver = false;
		paused = false;
		lvlCompleted = false;
        ...
        public void resetAllForLvlCompletedIfNotPlayContinue(){
            player.resetAllForLvlCompleted();
            objectManager.resetAllObjectsForGameOver();
            gameOver = false;
            paused = false;
	...
	public void setGameOver(boolean gameOver) {
        ...
        public void setBeforeGameOver(boolean beforeGameOver) {
            this.beforeGameOver = beforeGameOver;
        }
		...
		if (!gameOver && !gameCompleted && !lvlCompleted)
			...
			case KeyEvent.VK_ESCAPE:
				paused = !paused;
                                break;
                        case KeyEvent.VK_H:
                                if(game.getShop().getCount()[1] > 0){
                                    game.getShop().getCount()[1] -= 1;
                                }
                                break;
                        case KeyEvent.VK_P:
                                if(game.getShop().getCount()[0] > 0){
                                    game.getShop().getCount()[0] -= 1;
                                }
                                break;
                        case KeyEvent.VK_R:
                                break;
	...
	public void mousePressed(MouseEvent e) {
		if (gameOver)
			gameOverOverlay.mousePressed(e);
                        ...
                        beforeGameOverOverlay.mousePressed(e);
		else if (paused)
	...
	public void mouseReleased(MouseEvent e) {
		if (gameOver)
			gameOverOverlay.mouseReleased(e);
                        ...
                        beforeGameOverOverlay.mouseReleased(e);
		else if (paused)
	...
	public void mouseMoved(MouseEvent e) {
		if (gameOver)
			gameOverOverlay.mouseMoved(e);
                        ...
                        beforeGameOverOverlay.mouseMoved(e); 
		else if (paused)
	...
	public void setPlayerDying(boolean playerDying) {
        ...
        public boolean isBeforeGameOver() {
            return beforeGameOver;
        }
