 ...
 * @author MS NHUNG
 */
public class BeforeDeathButton {
    ...
    public BeforeDeathButton(int xPos, int yPos, int rowIndex){
            this.xPos = xPos;
            this.yPos = yPos;
	...
	private void loadImgs(){
		...
		BufferedImage temp = LoadSave.GetSpriteAtlas(LoadSave.DEATH_BUTTON_ATLAS);
