...
public class Player extends Entity {
	...
	private int powerGrowTick;
        ...
        private int xPosBeforeDie, yPosBeforeDie;
...
//            drawAttackBox(g, lvlOffset);
		...
		if (inAir && !powerAttackActive) {
			if (CanMoveHere(hitbox.x, hitbox.y + airSpeed, hitbox.width, hitbox.height, lvlData)) {
				...
				updateXPos(xSpeed);
                        ...
                        xPosBeforeDie = (int)hitbox.x - 21 * flipW;
	...
	public void resetAllForGameOver() {
		resetDirBooleans();
		inAir = false;
		attacking = false;
		moving = false;
        ...
        public void resetAllForLvlCompleted() {
		resetDirBooleans();
		inAir = false;
		attacking = false;
		moving = false;
    ...
    public int getxPosBeforeDie() {
        return xPosBeforeDie;
    }

    public void setxPosBeforeDie(int xPosBeforeDie) {
        this.xPosBeforeDie = xPosBeforeDie;
    }

    public int getyPosBeforeDie() {
        return yPosBeforeDie;
    }

    public void setyPosBeforeDie(int yPosBeforeDie) {
        this.yPosBeforeDie = yPosBeforeDie;
    }
